...
<div class="flex min-h-full items-center justify-center">
	<div class="flex flex-col gap-48 rounded-lg p-4">
		<div class="flex flex-col gap-10 items-center">
			...
			<p class="bg-clip-text text-slate-800 text-transparent">
				You need to be logged in to use the service
			</p>
		</div>
		<a
			class="current:tracking-widest flex w-full flex-row justify-between rounded-lg border-2 bg-cyan-200 p-2 text-lg text-slate-900 transition-[letter-spacing]"
